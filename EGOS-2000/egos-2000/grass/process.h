...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //Added lifecycle statistics fields
    ulonglong creation_time;        //time when process was created
    ulonglong first_run_time;       //time when process first got CPU 
    ulonglong cpu_time;             //total cpu execution time (microseconds)
    uint timer_interrupt_count;     //no. of timer interrups recieved by the process
    
    //Added MLFQ fields
    int mlfq_level;                   //current priority level (0-highest, 4-lowest)
    ulonglong mlfq_runtime_on_level;  //time spent on current priority level before potentially getting demoted
